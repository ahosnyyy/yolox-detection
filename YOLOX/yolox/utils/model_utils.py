...
def info_json(file_name, flops, params):
    # Create a dictionary with two values
    data = {
        "FLOPs":flops,
        "Params": params
    }
    ...
    file_path = os.path.join(file_name, 'model_info.json')
...
def get_model_info(model: nn.Module, tsize: Sequence[int], file_name) -> str:
